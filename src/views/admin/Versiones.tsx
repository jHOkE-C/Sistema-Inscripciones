    ...
    <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Button
                variant={
                  sortConfig.key === "fecha_inicio" ? "default" : "outline"
                }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
        {processedVersiones.map((version) => (
          ...
          >
            <CardHeader>
              <CardTitle className="text-xl">{version.nombre}</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="">
                <div className="flex items-center text-sm text-muted-foreground">
                  ...
                  <span>
                    {version.fecha_inicio} - {version.fecha_fin}
                  </span>
                </div>
                <div className="flex items-center text-sm text-muted-foreground">
                ...
                <div className="flex items-center justify-between">
                  <Badge variant="outline">Gestión {version.gestion}</Badge>
                  <Badge
                    variant={
                      version.estado === "Activo" ? "default" : "secondary"
                    }
                  >
                    {version.estado}
                  </Badge>
            ...
            <CardFooter>
              <Link to={`./${version.id}`} className="w-full">
                <Button className="w-full">{textoBoton}</Button>
              </Link>
            </CardFooter>
          </Card>
        ))}
