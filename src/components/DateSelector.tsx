...
export const DateSelector = React.memo(function DateSelector({
    ...
    return (
        <div className="flex gap-2">
            {/* Día */}
            <Select
                value={String(safeValue.getDate())}
                onValueChange={handleDayChange}
            >
                <SelectTrigger disabled={disabled} className="min-w-24 w-full">
            ...
            {/* Mes */}
            <Select
                value={String(safeValue.getMonth() + 1)}
            ...
            {/* Año */}
            <Select
                value={String(safeValue.getFullYear())}
