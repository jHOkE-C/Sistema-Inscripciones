...
export const getAreasByCategorias = async (olimpiadaId: number): Promise<AreaWithCategories[]> => {
  return await request<AreaWithCategories[]>(`/api/areas/categorias/olimpiada/${olimpiadaId}`);
};
