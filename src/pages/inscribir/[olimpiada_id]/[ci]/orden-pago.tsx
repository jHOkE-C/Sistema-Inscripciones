...
export default function OrdenPago({ codigo }: Props) {
  ...
  return (
    <div>
      <Button onClick={() => setFormOpen(true)} variant="link">
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="grid gap-5 py-4">
            <div className="grid grid-cols-2 gap-3 p-4 rounded-lg border">
              ...
              <div className="font-semibold">{datosPago.codigo_lista}</div>

              <div className="font-medium">Monto:</div>
              <div className="font-semibold">{datosPago.monto} Bs.</div>

              <div className="font-medium">Estado:</div>
              <div className="font-semibold capitalize">{datosPago.estado}</div>
