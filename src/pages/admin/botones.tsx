...
import { Users, Link as Asociar, Layers2, Trophy, Clock, FileUp, FileSpreadsheet, Check, UserPlus, ShieldUser, ShieldCheck, Layers, User } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 grid-">
        ...
        >
          <Link to="./reportes">
            ...
            <span className="text-lg font-semibold">Reportes de inscripciones</span>
          </Link>
        </Button>
